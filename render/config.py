...
tractor_lib_paths = [
    ...
    "{root}/lib/python2.7/lib/plat-win".format(root=tractor_install) if os.name == "nt" else "{root}/lib/python2.7/lib/plat-linux2".format(root=tractor_install),
